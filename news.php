...
wp_reset_postdata(); ?>
  ...
  <div class="container">
   ...
   <div class="container">
     ...
     <?php echo do_shortcode('[ajax_load_more post_type="post" destroy_after="2" posts_per_page="4" post_format="standard" category="noticias" scroll_container="carregar" button_label="Carregar mais"]'); ?>
